		...
		EXP_DATA = [
					{
						name: '默认',
						icons:[
							{url:"../../js/plugins/exp/img/zz2_thumb.gif",title:"织"},
							{url:"../../js/plugins/exp/img/horse2_thumb.gif",title:"神马"},
							{url:"../../js/plugins/exp/img/fuyun_thumb.gif",title:"浮云"},
							{url:"../../js/plugins/exp/img/geili_thumb.gif",title:"给力"},
							{url:"../../js/plugins/exp/img/wg_thumb.gif",title:"围观"},
							{url:"../../js/plugins/exp/img/vw_thumb.gif",title:"威武"},
							{url:"../../js/plugins/exp/img/panda_thumb.gif",title:"熊猫"},
							{url:"../../js/plugins/exp/img/rabbit_thumb.gif",title:"兔子"},
							{url:"../../js/plugins/exp/img/otm_thumb.gif",title:"奥特曼"},
							{url:"../../js/plugins/exp/img/j_thumb.gif",title:"囧"},
							{url:"../../js/plugins/exp/img/hufen_thumb.gif",title:"互粉"},
							{url:"../../js/plugins/exp/img/liwu_thumb.gif",title:"礼物"},
							{url:"../../js/plugins/exp/img/smilea_thumb.gif",title:"呵呵"},
							{url:"../../js/plugins/exp/img/tootha_thumb.gif",title:"嘻嘻"},
							{url:"../../js/plugins/exp/img/laugh.gif",title:"哈哈"},
							{url:"../../js/plugins/exp/img/tza_thumb.gif",title:"可爱"},
							{url:"../../js/plugins/exp/img/kl_thumb.gif",title:"可怜"},
							{url:"../../js/plugins/exp/img/kbsa_thumb.gif",title:"挖鼻屎"},
							{url:"../../js/plugins/exp/img/cj_thumb.gif",title:"吃惊"},
							{url:"../../js/plugins/exp/img/shamea_thumb.gif",title:"害羞"},
							{url:"../../js/plugins/exp/img/zy_thumb.gif",title:"挤眼"},
							{url:"../../js/plugins/exp/img/bz_thumb.gif",title:"闭嘴"},
							{url:"../../js/plugins/exp/img/bs2_thumb.gif",title:"鄙视"},
							{url:"../../js/plugins/exp/img/lovea_thumb.gif",title:"爱你"},
							{url:"../../js/plugins/exp/img/sada_thumb.gif",title:"泪"},
							{url:"../../js/plugins/exp/img/heia_thumb.gif",title:"偷笑"},
							{url:"../../js/plugins/exp/img/qq_thumb.gif",title:"亲亲"},
							{url:"../../js/plugins/exp/img/sb_thumb.gif",title:"生病"},
							{url:"../../js/plugins/exp/img/mb_thumb.gif",title:"太开心"},
							{url:"../../js/plugins/exp/img/ldln_thumb.gif",title:"懒得理你"},
							{url:"../../js/plugins/exp/img/yhh_thumb.gif",title:"右哼哼"},
							{url:"../../js/plugins/exp/img/zhh_thumb.gif",title:"左哼哼"},
							{url:"../../js/plugins/exp/img/x_thumb.gif",title:"嘘"},
							{url:"../../js/plugins/exp/img/cry.gif",title:"衰"},
							{url:"../../js/plugins/exp/img/wq_thumb.gif",title:"委屈"},
							{url:"../../js/plugins/exp/img/t_thumb.gif",title:"吐"},
							{url:"../../js/plugins/exp/img/k_thumb.gif",title:"打哈气"},
							{url:"../../js/plugins/exp/img/bba_thumb.gif",title:"抱抱"},
							{url:"../../js/plugins/exp/img/angrya_thumb.gif",title:"怒"},
							{url:"../../js/plugins/exp/img/yw_thumb.gif",title:"疑问"},
							{url:"../../js/plugins/exp/img/cza_thumb.gif",title:"馋嘴"},
							{url:"../../js/plugins/exp/img/88_thumb.gif",title:"拜拜"},
							{url:"../../js/plugins/exp/img/sk_thumb.gif",title:"思考"},
							{url:"../../js/plugins/exp/img/sweata_thumb.gif",title:"汗"},
							{url:"../../js/plugins/exp/img/sleepya_thumb.gif",title:"困"},
							{url:"../../js/plugins/exp/img/sleepa_thumb.gif",title:"睡觉"},
							{url:"../../js/plugins/exp/img/money_thumb.gif",title:"钱"},
							{url:"../../js/plugins/exp/img/sw_thumb.gif",title:"失望"},
							{url:"../../js/plugins/exp/img/cool_thumb.gif",title:"酷"},
							{url:"../../js/plugins/exp/img/hsa_thumb.gif",title:"花心"},
							{url:"../../js/plugins/exp/img/hatea_thumb.gif",title:"哼"},
							{url:"../../js/plugins/exp/img/gza_thumb.gif",title:"鼓掌"},
							{url:"../../js/plugins/exp/img/dizzya_thumb.gif",title:"晕"},
							{url:"../../js/plugins/exp/img/bs_thumb.gif",title:"悲伤"},
							{url:"../../js/plugins/exp/img/crazya_thumb.gif",title:"抓狂"},
							{url:"../../js/plugins/exp/img/h_thumb.gif",title:"黑线"},
							{url:"../../js/plugins/exp/img/yx_thumb.gif",title:"阴险"},
							{url:"../../js/plugins/exp/img/nm_thumb.gif",title:"怒骂"},
							{url:"../../js/plugins/exp/img/hearta_thumb.gif",title:"心"},
							{url:"../../js/plugins/exp/img/unheart.gif",title:"伤心"},
							{url:"../../js/plugins/exp/img/pig.gif",title:"猪头"},
							{url:"../../js/plugins/exp/img/ok_thumb.gif",title:"ok"},
							{url:"../../js/plugins/exp/img/ye_thumb.gif",title:"耶"},
							{url:"../../js/plugins/exp/img/good_thumb.gif",title:"good"},
							{url:"../../js/plugins/exp/img/no_thumb.gif",title:"不要"},
							{url:"../../js/plugins/exp/img/z2_thumb.gif",title:"赞"},
							{url:"../../js/plugins/exp/img/come_thumb.gif",title:"来"},
							{url:"../../js/plugins/exp/img/sad_thumb.gif",title:"弱"},
							{url:"../../js/plugins/exp/img/lazu_thumb.gif",title:"蜡烛"},
							{url:"../../js/plugins/exp/img/clock_thumb.gif",title:"钟"},
							{url:"../../js/plugins/exp/img/cake.gif",title:"蛋糕"},
							{url:"../../js/plugins/exp/img/m_thumb.gif",title:"话筒"}
						]
					}
				],
