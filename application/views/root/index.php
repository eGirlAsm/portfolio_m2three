...
<head>
<link href="<?php echo base_url(); ?>css/admin_header.css" rel="stylesheet" type="text/css">
...
<table cellpadding="0" cellspacing="0" height="100%" border="0" width="100%">
  <tbody>
    <tr>
      <td colspan="3"><div class="header"><!-- 头部 begin -->
          <div class="logo"> <a href="http://www.moonyuan.com/thinksns/index.php?app=admin&amp;mod=Index&amp;act=index"><strong style="font-size:18px;">管理中心</strong></a> </div>
          <div class="nav_sub"> 您好,管理员&nbsp; | <a href="http://www.moonyuan.com/thinksns/index.php?app=public&amp;mod=Index&amp;act=index">返回前台</a> | <a href="javascript:void(0);" onclick="refresh();">刷新</a> | <a href="http://www.moonyuan.com/thinksns/index.php?app=admin&amp;mod=Public&amp;act=logout">退出</a><br>
            <div id="TopTime"></div>
          </div>
          <div class="main_nav"> <a id="channel_index" class="on" href="javascript:void(0)" onclick="switchChannel('index');" hidefocus="true" style="outline:none;">首页</a><a id="channel_system" href="javascript:void(0)" onclick="switchChannel('system');" hidefocus="true" style="outline:none;">系统</a><a id="channel_user" href="javascript:void(0)" onclick="switchChannel('user');" hidefocus="true" style="outline:none;">用户</a><a id="channel_content" href="javascript:void(0)" onclick="switchChannel('content');" hidefocus="true" style="outline:none;">内容</a><a id="channel_task" href="javascript:void(0)" onclick="switchChannel('task');" hidefocus="true" style="outline:none;">任务</a><a id="channel_apps" href="javascript:void(0)" onclick="switchChannel('apps');" hidefocus="true" style="outline:none;">应用</a><a id="channel_extends" href="javascript:void(0)" onclick="switchChannel('extends');" hidefocus="true" style="outline:none;">插件</a> <a href="#" onclick="gotoApp(this,'page/Admin/index')" appname="page">门户</a> </div>
        </div>
        <div class="header_line"><span>&nbsp;</span></div></td>
    </tr>
    <tr>
      <td id="FrameTitle" height="100%" background="<?php echo base_url(); ?>images/admin/left_bg.gif" valign="top" width="200px"><div class="LeftMenu"> 
          <!-- 第一级菜单，即大频道 -->
          <ul style="display: block;" class="MenuList" id="root_index">
            <!-- 第二级菜单 -->
            <li style="background-image: url(&quot;<?php echo base_url(); ?>images/admin/ArrOff.png&quot;);" class="treemenu"> <a id="root_1" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('1');" hidefocus="true" style="outline:none;">首页</a>
          ...
          <ul class="MenuList" id="root_system" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_13" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('13');" hidefocus="true" style="outline:none;">系统配置</a>
          ...
          <ul class="MenuList" id="root_user" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_31" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('31');" hidefocus="true" style="outline:none;">用户</a>
          ...
          <ul class="MenuList" id="root_content" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_39" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('39');" hidefocus="true" style="outline:none;">内容管理</a>
          ...
          <ul class="MenuList" id="root_task" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_50" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('50');" hidefocus="true" style="outline:none;">任务管理</a>
          ...
          <ul class="MenuList" id="root_apps" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_56" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('56');" hidefocus="true" style="outline:none;">应用管理</a>
          ...
          <ul class="MenuList" id="root_extends" style="display:none;">
            <!-- 第二级菜单 -->
            <li class="treemenu"> <a id="root_62" class="actuator" href="javascript:void(0)" onclick="switch_root_menu('62');" hidefocus="true" style="outline:none;">插件管理</a>
...
<script type="text/javascript">
	...
	function switch_root_menu(root) {
		...
		if (root.css('display') == 'block') {
			...
			root.parent().css('backgroundImage', 'url(<?php echo base_url()?>images/admin/image/ArrOn.png)');
		}else {
			root.css('display', 'block');
			root.parent().css('backgroundImage', 'url(<?php echo base_url()?>images/admin/ArrOff.png)');
		}
	}
