...
<div id="job_contents">
  <div class="job_center">
    <div id="job_list">
      <div id="secondhand_list_header" ><a href="<?php echo site_url(); ?>/job">
        <h2></h2>
        </a>
        <?php $this->load->view('public/_topmenu'); ?>
                <script>
		$(document).ready(function() {
            $('.other_info a').eq(4).addClass('on');
        });
		</script>
      </div>
      <div id="job_tb_header">
        <ul>
          ...
          <li style="width:300px;">제목</li>
          <li style="width:110px;">분류</li>
  ...
  <?php $this->load->view('secondhand/right'); ?>
</div>
