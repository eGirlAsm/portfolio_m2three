...
<link rel="stylesheet" href="<?php echo base_url(); ?>editor/css/editor.css" type="text/css" charset="utf-8"/>
<script src="<?php echo base_url(); ?>editor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
<div id="view_community_contents">
  ...
  <div id="community_content_write">
    <div id="community_content_center"> 
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="<?php echo base_url().$this->uri->uri_string(); ?>?action=commit" method="post" accept-charset="utf-8">
        <div id="community_content_title"><span class="w_title"> 제목 </span>
<input id="subject" type="text" maxlength="40" style="width: 679px;" name="subject"></input></div>
<div id="community_content_editor">
		<!-- 에디터 컨테이너 시작 -->
...
<!-- 에디터 끝 -->
<div id="community_btn_bottom"><ul><li style="float:right;padding:0px 0px 0px 0px;"><input type="button" class="btn btn-primary" onclick='saveContent()' value="글저장" /><input type="button" class="btn btn-inverse" onclick='history.go(-1)' value="취소" /></li><li></li></ul></div>
<script type="text/javascript">
	var config = {
		...
		txIconPath: "<?=base_url();?>editor/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "<?=base_url();?>editor/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
...
<script type="text/javascript">
    ...
    <div id="community_content_right"><script type="text/javascript"><!--
google_ad_client = "ca-pub-7834010976620784";
/* newpost */
google_ad_slot = "6153788756";
google_ad_width = 160;
