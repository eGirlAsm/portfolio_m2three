...
<div id="job_contents">
  <div class="job_center">
    <div id="job_list">
      <div id="tenement_list_header" ><a href="<?php echo site_url(); ?>/job">
        <h2></h2>
        </a>
        <?php $this->load->view('public/_topmenu'); ?>
                <script>
		$(document).ready(function() {
            $('.other_info a').eq(3).addClass('on');
        });
		</script>
      </div>
      <div id="job_tb_header">
        <ul>
          ...
          <li style="width:300px;">제목/설비/가구</li>
          <li style="width:110px;">층계</li>
          <li style="width:85px;">가격</li>
  ...
  <?php $this->load->view('tenement/right'); ?>
</div>
