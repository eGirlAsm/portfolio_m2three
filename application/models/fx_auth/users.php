...
{
	private $table_name			= 'm23_users';			// user accounts
	private $profile_table_name	= 'm23_user_profiles';	// user profiles
	private $roles_table			= 'm23_roles';			// user accounts
	...
	function __construct()
	{
		...
		$this->profile_table_name	= $ci->config->item('db_table_prefix', 'fx_auth').$this->profile_table_name;
	}
